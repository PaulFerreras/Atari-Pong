...
public class Sounds {
	...
	public Sounds() {
		...
		//Player Bounce
		try {
			sound_file = new FileInputStream("D:/Users/pferr/Desktop/Workspace/Atari Pong/Sounds/player bounce.wav");
		...
		//Wall Bounce
		try {
			sound_file = new FileInputStream("D:/Users/pferr/Desktop/Workspace/Atari Pong/Sounds/wall bounce.wav");
			buffered_input_stream = new BufferedInputStream(sound_file);
			audio_input_stream = AudioSystem.getAudioInputStream(buffered_input_stream);
		...
		//Score
		try {
			sound_file = new FileInputStream("D:/Users/pferr/Desktop/Workspace/Atari Pong/Sounds/score.wav");
			buffered_input_stream = new BufferedInputStream(sound_file);
			audio_input_stream = AudioSystem.getAudioInputStream(buffered_input_stream);
